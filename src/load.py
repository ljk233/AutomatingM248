...
def home_advantage() -> pd.DataFrame:
    """
    Returns the data in home_advantage.csv as a pandas DataFrame.
    """

    return _load("home_advantage")


def epl_1718() -> pd.DataFrame:
    """
    Returns the data in epl_1718.csv as a pandas DataFrame.
    """

    return _load("epl_1718")


def coins() -> pd.DataFrame:
    """
    Returns the data in coins.csv as a pandas DataFrame.
    """
