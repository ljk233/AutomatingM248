...
Then $X$ is modelled by the binomial distribution, $X \sim B(n,p)$, where $n=12$ is the sample size and $p=0.03$ is the probability that a patiet reacts unfavourably to the treatment, so $X \sim B(12,0.03)$.
